...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable().cors().and().authorizeRequests()
				...
				.antMatchers(HttpMethod.GET, "/page/cpagrip").permitAll()
				.antMatchers(HttpMethod.POST, "/cpagrip/postback").permitAll()
				.antMatchers(HttpMethod.GET, "/adworkmedia/postback").permitAll()
				.antMatchers(HttpMethod.GET, "/cpalead/postback").permitAll()
